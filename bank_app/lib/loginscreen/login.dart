              ...
              Expanded(child: Stack(
                children: [
                  Container(
                    height: size.height,
                    width: size.width,
                    child: Image(image: AssetImage('assets/backg.jpg'),fit: BoxFit.fill,),
                  ),
                  Center(
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          Text('Login Page',style: TextStyle(color: Colors.black,fontSize: 30,fontWeight: FontWeight.bold)),
                          SizedBox(height: 20,),
                          Padding(
