...
String plsenteruser = 'Please Enter UserName';
String plsenterpass = 'Please Enter Password';
String enterurunm = 'Enter Your UserName';
...
String showtask = 'showtask';

//slist
String slst = 'Student List';
